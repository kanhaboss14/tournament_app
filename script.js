function getUsernameFromLocalStorage() {
  return localStorage.getItem('krish_local');
}
...
function fetchUserCoins(username) {
  ...
  const url = 'https://script.google.com/macros/s/AKfycbz_qdEtLZ45t1Ob2txHIY-nyKW2t40nkYaUKTPDIo-teyNsEAJzy6G6irjkfreHblua/exec';
