const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbyb7fbmEesXvtNjzRdHV11bKJIfGx-bYLzUAtACMmjDUEFycb9pzcWho4tfWn5TdvKA/exec";

if (localStorage.getItem('krish_local')) {
...
async function submitData() {
    ...
    try {
        ...
        if (result.status === 'success') {
            ...
            localStorage.setItem('krish_local', formData.username);
